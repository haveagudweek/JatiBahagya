    ...
    <div class="container my-5">
        <div class="row justify-content-center">
            ...
            <div class="col-md-9 mb-3">
                <div class="card">
                    <div class="card-header">Edit Alamat</div>
                    <div class="card-body">
                        <!-- Flash Message -->
                        @if (session('success'))
                        ...
                        <form action="{{ route('address.update', $address->id) }}" method="POST">
                                ...
                                <select name="province_id" id="province" class="form-control" required>
                                    ...
                                    @foreach ($provinces as $province)
                                        <option value="{{ $province->id }}" 
                                            {{ $province->id == $address->id_province ? 'selected' : '' }}>
                                            {{ $province->name }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <select name="regency_id" id="regency" class="form-control" required>
                                    ...
                                    @foreach ($regencies as $regency)
                                        <option value="{{ $regency->id }}" 
                                            {{ $regency->id == $address->id_regency ? 'selected' : '' }}>
                                            {{ $regency->name }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <select name="district_id" id="district" class="form-control" required>
                                    ...
                                    @foreach ($districts as $district)
                                        <option value="{{ $district->id }}" 
                                            {{ $district->id == $address->id_district ? 'selected' : '' }}>
                                            {{ $district->name }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <select name="village_id" id="village" class="form-control" required>
                                    ...
                                    @foreach ($villages as $village)
                                        <option value="{{ $village->id }}" 
                                            {{ $village->id == $address->id_village ? 'selected' : '' }}>
                                            {{ $village->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="full_address" class="form-control" value="{{ old('full_address', $address->full_address) }}" required>
                            </div>
